...
ALTER TABLE public.retencao_respostas
  ADD COLUMN IF NOT EXISTS wa_acesso_enviado_em timestamptz;
    ...
    'kanban_clientes', (
      SELECT COALESCE(json_agg(json_build_object(
        ...
        'coluna_kanban', CASE
          ...
          WHEN cd.ultimo_resultado = 'whatsapp_aceitou_presente_revista' THEN 'aceitou_presente'
          WHEN cd.ultimo_resultado = 'interessado' THEN 'interessado'
